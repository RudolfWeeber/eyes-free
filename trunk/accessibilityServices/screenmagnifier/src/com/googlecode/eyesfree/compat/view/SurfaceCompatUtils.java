...
/**
 * Provides access to {@link android.view.Surface} methods.
 *
 * @author alanv@google.com (Alan Viverette)
 */
public class SurfaceCompatUtils {
    private static final Class<?> CLASS_Surface = Surface.class;
    private static final Method METHOD_screenshot_II = CompatUtils.getMethod(CLASS_Surface,
            "screenshot", int.class, int.class);

    private SurfaceCompatUtils() {
