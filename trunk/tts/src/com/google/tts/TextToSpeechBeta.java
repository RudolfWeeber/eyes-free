 ...
 * initialization. Implement the {@link TextToSpeechBeta.OnInitListener} to be
...
//    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    ...
    public interface OnInitListener {
         ...
         * @param status {@link TextToSpeechBeta#SUCCESS} or {@link TextToSpeechBeta#ERROR}.
         */
    ...
    public interface OnUtteranceCompletedListener {
         ...
         * {@link TextToSpeechBeta#synthesizeToFile(String, HashMap, String)} with the
         * {@link TextToSpeechBeta.Engine#KEY_PARAM_UTTERANCE_ID} key.
...
//        @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
     ...
     * @param listener
     *            The {@link TextToSpeechBeta.OnInitListener} that will be called when the
