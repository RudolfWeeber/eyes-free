...
// Taken from:
// http://code.google.com/p/android-cookbook/source/browse/trunk/GroupHome/src/org/jsharkey/grouphome/UserTask.java
    ...
    mFuture = new FutureTask<Result>(mWorker) {
      ...
      protected void done() {
        ...
        final Message message =
            sHandler.obtainMessage(MESSAGE_POST_RESULT, new UserTaskResult<Result>(UserTask.this,
                result));
